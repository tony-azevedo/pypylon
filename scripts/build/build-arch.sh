...
case $PLATFORM_TAG in
    ...
    # manylinux2014_armv7l is built using debian because there is currently no quay.io/pypa/manylinux2014_armv7l docker image
    manylinux2014_armv7l)   QEMU_ARCH="arm";      BASE_IMAGE="arm32v7/$BASE_IMAGE";                  PYLON_ARCH=armhf ;;
    *)
